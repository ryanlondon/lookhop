...
var App = function (_Component) {
  ...
  function App() {
    ...
    _this.instagramOAuth = _this.instagramOAuth.bind(_this);
    return _this;
  }

  _createClass(App, [{
    key: 'instagramOAuth',
    value: function instagramOAuth() {
      fetch('/login/instagram').then(function () {
        return console.log('Instagram callback');
      });
    }
  }, {
    key: 'render',
